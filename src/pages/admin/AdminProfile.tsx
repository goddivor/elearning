...
import { Edit2, Save2, CloseSquare, Lock, Camera, Shield } from 'iconsax-react';
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {/* Banner */}
        <div
          className="relative h-48 bg-gradient-to-r from-red-500 to-orange-600 overflow-hidden"
          ...
          <div className="flex items-end justify-between -mt-16 mb-6">
            <div className="flex items-end gap-4">
              ...
              <div className="pb-2">
                ...
                <p className="text-red-600 font-medium flex items-center gap-2 mt-1">
